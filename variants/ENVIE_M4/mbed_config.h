...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC|USE_PLL_HSI                                                                     // set by target:ENVIE_M4
#define HSE_VALUE                                                             25000000                                                                                         // set by target:ENVIE_M4
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:ENVIE_M4
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:ENVIE_M4
