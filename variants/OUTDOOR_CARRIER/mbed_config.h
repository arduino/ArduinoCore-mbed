...
#define MBED_CONF_SD_SPI_CLK                                                  P0_19                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_SD_SPI_CS                                                   P1_12                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_SD_SPI_MISO                                                 P0_21                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_SD_SPI_MOSI                                                 P0_20                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
...
#define MBED_CONF_SPIF_DRIVER_SPI_CLK                                         P0_19                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_SPIF_DRIVER_SPI_CS                                          P0_17                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_SPIF_DRIVER_SPI_FREQ                                        40000000                                                                                         // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_MISO                                        P0_21                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_SPIF_DRIVER_SPI_MOSI                                        P0_20                                                                                            // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_STORAGE_DEFAULT_KV                                          kv                                                                                               // set by application[ARDUINO_OUTDOOR_CARRIER]
...
#define MBED_CONF_STORAGE_STORAGE_TYPE                                        TDB_EXTERNAL                                                                                     // set by application[ARDUINO_OUTDOOR_CARRIER]
#define MBED_CONF_STORAGE_TDB_EXTERNAL_BLOCKDEVICE                            SPIF                                                                                             // set by application[ARDUINO_OUTDOOR_CARRIER]
