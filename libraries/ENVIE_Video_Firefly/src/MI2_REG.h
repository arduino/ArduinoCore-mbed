...
/*Register definition of device address 0x70*/
    ...
    #define  DP_CONFIG_3         0x84
        /* bit positions */
        #define  BPC                   5  /* bit[7:5] are bpc -  bits per channel, a.k.a. bits per color, i.e. bits per component */
                                          /* 011: 12 bit */
                                          /* 010: 10 bit */
                                          /* 001:  8 bit */
                                          /* 000:  6 bit */
        ...
        #define  D_RANGE               3  /* dynamic range: video or graphics */
        #define  COLOR_F               1  /* color space and chroma format: 00: RGB,  01: YCbCr422,  10: YCbCr444,  11: reserved */
        #define  SYNC_MODE             0
...
#define TDM_TIMING_MODE 0x08
    ...
    #define  VIDEO_CONTROL_0  0x08
        ...
        #define  VIDEO_EN             7
        /* bit[6] is reserved */
        #define  DE_GEN               5  /* DE re-generation mode: 1=enabled, 0=disabled */
        #define  DEMUX                4  /* De YC-MUX: 1=enabled, 0=disabled */
        #define  HALF_FREQUENCY_MODE  3  /* bit[3] is reserved in MI-2 */
        #define  DDR_MODE             2  /* alwaysa set bit[2] to 1 in MI-2 */
        #define  DDR_CTRL             1
    ...
    #define  VIDEO_CONTROL_2  0x0A
        /* bit positions */
        #define  IN_YC_COEFFI       7  /* YCbCr cofficients of input video: 1=ITU709, 0=ITU601 */
        #define  HDMI_HPD           6  /* reserved in MI-2 */
        #define  DE_DELAY           5  /* dalay one pixel of DE: 1=enabled, 0=disabled */
        #define  VID_CHK_UPDATE_EN  4  /* update enable control of video format parameter check in video capture block: 1=enabled, 0=disabled */
    ...
    #define  VIDEO_CONTROL_5  0x0D
        ...
        #define  VID_US_MODE        3  /* up sampling mode:   1=FIR filter, 0=copy sample */
        #define  VID_DS_MODE        2  /* down sampling mode: 1=FIR filter, 0=skip sample */
        #define  UP_SAMPLE          1  /* reserved in MI-2 */
        #define  DOWN_SAMPLE        0  /* 4:4:4 to 4:2:2 down sampling: 1=enabled, 0=disabled */
    ...
    #define  DPPLL_REG4               0xF9
        ...
        #define  test_sig_sel   0  /* DPPLL_REG4[1:0] is test signal selection */
                                   /*  when atest_enable = 1,
                                       ...
                                       11: vcox */
                                   /*  when dtest_enable = 1,
                                       00: refbx (\wr 7e 42 f; \wr 7e 81 e1; \wr 7a f9 4 ==> Now on WS pin, you'd see a 27 MHz clock.)
                                       01: ckfbx (\wr 7e 42 f; \wr 7e 81 e1; \wr 7a f9 5 ==> Now on WS pin, you'd see a 27 MHz signal.
                                                  However, this signal is neither square wave nor sine wave, it should be narrow pulses.)
                                       10: ck_vco
                                       11: avss10 */
...
/*Register definition of device address 0x7e*/
    ...
    /* note: The actual implementation doesn't match register spec v0.5 - High byte and low byte are reversed. */
    ...
    #define  STATUS_REGISTER_IN  0x34  /* the value to be written into Flash status register */
    #define  REMS_READ_ADDR  0x35  /* Flash REMS READ DATA (depend on Flash vendor definition) */
    ...
    #define  XTAL_FRQ_SEL    0x3F
	 ...
	 #define  XTAL_FRQ_26M     (3 << XTAL_FRQ_SEL_POS)
    ...
    #define  GPIO_CTRL_1     0x48
        ...
        #define  FLASH_WP     3  /* When bonding with Flash, this register will control the flash WP pin */
    ...
    #define  HORIZON_FRONT_PORCH_H_7E  0x55   /* note: bit[7:4] are EEPROM Key 0, which is not used in MI-2 */

    #define  HORIZON_SYNC_WIDTH_L_7E   0x56
    #define  HORIZON_SYNC_WIDTH_H_7E   0x57   /* note: bit[7:4] are EEPROM Key 1, which is not used in MI-2 */

    #define  HORIZON_BACK_PORCH_L_7E   0x58
    #define  HORIZON_BACK_PORCH_H_7E   0x59   /* note: bit[7:4] are EEPROM Key 2, which is not used in MI-2 */
...
#define AP_AUX_CTRL_STATUS 0x14  /* note: bit[0:3] AUX status, bit 4 op_en, bit 5 address only */
...
#define AP_AV_STATUS 0x28    //bit 0&1: 3D video structure 0x01: frame packing,  0x02:Line alternative, 0x03:Side-by-side(full)
...
#define  MIPI_LANE_CTRL_0                0x05
        ...
        #define  MIPI_ACTIVE_LANE              0  /* bit[1:0] - 00: 1 lane, 01: 2 lanes, 10: 3 lanes, 11: 4 lanes */

#define  MIPI_TIME_HS_PRPR               0x08

    /* After MIPI RX protocol layer received this many video frames, protocol layer starts to reconstruct video stream from PHY */
...
#define  MIPI_LANE_CTRL_10               0x0F
        ...
        #define  MIPI_LANE_SWAP          4   /* bit[5:4] - Debug mode to swap MIPI data lanes */
    ...
    #define  MIPI_RX_REG4               0x14
        /* bit positions */
        #define  hsrx_rterm        4  /* MIPI_RX_REGx[7:4] is hsrx_rterm[3:0], x=0~4; x=0~3 are for data lanes 0~3, x=4 is for clock */
                                      /* defines the HS RX termination impedance:
                                           0000: 125 Ohm
                                           0110: 100 Ohm (default)
                                           1111:  75 Ohm  */
        #define  sel_hs_dly        1  /* MIPI_RX_REGx[3:1] is sel_hs_dly[2:0], x=0~4; x=0~3 are for data lanes 0~3, x=4 is for clock */
                                      /* defines the hsrx data delay; adjust the data/clock edge timing
                                           ...
                                           note: The descriptions above come from an internal documentation mi2-analog_pinlist_v1.4.xlsx.
    ...
    #define  MIPI_RX_REG5               0x15
        ...
        #define  ref_sel_lpcd      6  /* MIPI_RX_REG5[7:6] is ref_sel_lpcd[1:0] */
                                      /*  define the lpcd refrence voltage
                                            00: 250 mV
                                            01: 300 mV (default)
                                            10: 350 mV
                                            11: 400 mV  */
        #define  ref_sel_lprx      4  /* MIPI_RX_REG5[5:4] is ref_sel_lprx[1:0] */
                                      /*  define the lprx refrence voltage
                                            00: 650 mV
                                            01: 700 mV (default)
                                            10: 750 mV
                                            11: 800 mV */
    ...
    #define  MIPI_RX_REG7               0x17
        ...
        #define  dpi_ck_delay      5  /* MIPI_RX_REG7[7:5] is dpi ck delay config */
                                      /*  0xx no delay
                                          ...
                                          110 120*3 ps
                                          111 120*4 ps  */
        #define  test_enable       4  /* MIPI_RX_REG7[4] is test enable: 1: enable, 0: disable */
        #define  test_signal_sel   0  /* MIPI_RX_REG7[3:0] is test signal selection */
                                      /*         dtesto / atesto
    ...
    #define  MIPI_DIGITAL_ADJ_1   0x1B
        /* bit positions */
        #define  DIFF_I_RATIO      4  /* bit[7:4]: Integral part ratio of the adjust loop */
                                      /*  0~7: 1/(2^(n+3))
                                         >= 8: reserved */

        #define  DIFF_K_RATIO      0  /* bit[3:0]: The total adjust loop ratio to the feedback block */
                                      /*  0~0xF: 1/(2^n) */
    ...
    #define  MIPI_DIGITAL_PLL_6     0x2A
        /* bit positions */
        #define  MIPI_PLL_BAND_REG       6  /* bit[7:6]: VCO band control, only effective when MIPI_PLL_FORCE_BAND_EN (0x84:0x2B[6]) is 1 */
                                            /* f_vco frequency:
                                                 band 0:    1 ~ 1.15 GHz
                                                 band 1: 1.15 ~ 1.3  GHz
                                                 band 2:  1.3 ~ 1.5  GHz
        ...
        #define  MIPI_PLL_TEST_BIT       0  /* bit[1:0]: test point output select - 00: VCO power, 01: dvdd_pdt, 10: dvdd, 11: vcox */

    #define  MIPI_DIGITAL_PLL_7     0x2B
        /* bit positions */
        #define  MIPI_PLL_FORCE_N_EN     7
        #define  MIPI_PLL_FORCE_BAND_EN  6
        #define  MIPI_PLL_VCO_TUNE_REG   4  /* bit[5:4]: VCO metal capacitance - 00: +20% fast, 01: +10% fast (default), 10: typical, 11: -10% slow */
        #define  MIPI_PLL_PLL_LDO_BIT    2  /* bit[3:2]: vco_v2i power - 00: 1.40V, 01: 1.45V (default), 10: 1.50V, 11: 1.55V */
    ...
    #define  MIPI_ALERT_CLR_0     0x2D
        /* bit positions */
        #define  HS_link_error_clear      7  /* This bit itself is S/C, and it clears 0x84:0x31[7] */


    #define  MIPI_ALERT_OUT_0     0x31
        /* bit positions */
        #define  check_sum_err_hs_sync      7    /* This bit is cleared by 0x84:0x2D[7] */

    #define  MIPI_DIGITAL_PLL_8   0x33
        /* bit positions */
        #define  MIPI_POST_DIV_VAL     4    /* n means divided by (n+1), n = 0~15 */
    ...
    #define  H_BLANK_L            0x3E  /* for DSC only */
    #define  H_BLANK_H            0x3F  /* for DSC only; note: bit[7:6] are reserved */
