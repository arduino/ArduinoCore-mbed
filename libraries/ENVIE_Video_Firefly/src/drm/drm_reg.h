...
#define DRM_Interrupt               0xFF		/*_at_ 0x1100 + 0x24*/ //84:FF
#define INTR                    (0x01)
...
#define DRM_Reserved1               0x88		/*_at_ 0x1080 + 0x08~0x09*/ //84:88~89, 2Bytes, 84:89 cannot be used;
...
#define Status_Lock             (0x100)
#define Enc_Level_Error         (0x200)
#define MI_2_Auth_Status        (0xC00)

#define DRM_Reserved2               0x8C		/*_at_ 0x1080 + 0x0C~0x0F*/ //84:8C~8F, 4Bytes
...
#define DRM_Reserved3               0xE0		/*_at_ 0x1080 + 0x60~0x69*/ //84:E0~E9, 10Bytes
