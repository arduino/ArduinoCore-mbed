...
public:
   ...
   * This will turn off the battery FET and thus isolate the battery from the system.
   * So, whatevery is leaky in our system won't be leaky out of the battery during this time.
   * 
   * @return true 
   * @return false 
   */
   ...
   * @param useLatchedValue Before entering a low power state, the device will determine the voltage
  ...
  /**
   * @brief Get a textual Battery Charge description. The following values are possible:
   * "Unknown", "Full, "Almost Full", "Half Full", "Almost Empty", "Empty". 
   * 
