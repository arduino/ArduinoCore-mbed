...
void USBHID::init(EndpointResolver& resolver)
{
...
uint32_t USBHID::callback_request(const setup_packet_t *setup, USBDevice::RequestResult *result, uint8_t** data)
{
            ...
            case GET_DESCRIPTOR:
                switch (DESCRIPTOR_TYPE(setup->wValue)) {
                    ...
                    case HID_DESCRIPTOR:
                        ...
                        hidDescriptor = PluggableUSBD().find_descriptor(HID_DESCRIPTOR);
